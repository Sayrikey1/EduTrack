...
DATABASES = {
    "default": {
        ...
        "USER": os.getenv("DB_USERNAME") or os.getenv("TEST_DB_USERNAME"),
        "PASSWORD": os.getenv("DB_PASSWORD") or os.getenv("TEST_DB_PASSWORD"),
        "HOST": os.getenv("DB_HOST") or os.getenv("TEST_DB_HOST") or "localhost",
        "PORT": os.getenv("DB_PORT") or os.getenv("TEST_DB_PORT") or "5432",
        # "TEST": {
        #     "NAME": os.getenv("TEST_DB_NAME") or "edutrack-test",
        # },
    },
    # 'default': {
...
print("APP_ENC_ENABLED", APP_ENC_ENABLED)
